...
<link rel="stylesheet" type="text/css" href="{-:*__THEME__-}home/css/a_t.css" />
	...
	<div class="w_650 f_l">
		...
		<div class="adiv p_20">
			...
			<div class="main_info fc_gry_d">
				...
				<span><strong class="fc_gry">{-:@EDITOR-}</strong>{-:$_V['m_username']-}</span>
		...
		{-else:-}
			<div class="main_content">
				<div class="thematic_info">
					<img class="f_l thematic_thumb" src="{-:$_V['a_thumb']-}" />
					<div class="thematic_abstract">{-:$_V['a_t_abstract']-}</div>
					<div class="c"></div>
				</div>
			{-foreach:$_V['a_t_node'],$nk,$node-}
				<dl class="adl f_l w_250">
					<dt><strong>{-:$node['name']-}</strong><span class="fc_gry">[{-:$node['alias']-}]</span></dt>
					<dd>
						<ul class="aul">
				...
				{-if:1==$nk%2-}<div class="w_10 h_10 o_h f_l">&nbsp;</div>{-else:-}<div class="c"></div><div class="h_10 o_h"></div>{-:/if-}
			{-:/foreach-}
			</div><!--/.main_content-->
		{-:/if-}
