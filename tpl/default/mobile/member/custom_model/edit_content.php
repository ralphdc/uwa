...
<head>
<meta charset="utf-8" />
<title>{-:@EDIT-} {-:$_CMI['cm_name']-} - {-:$_SITE['name']-}</title>
...
<dl class="adl margin-top-sm">
	<dt><h5><i class="icon icon-plus"></i> {-:@EDIT-} {-:$_CMI['cm_name']-}</h5><span class="float-right"><a class="btn_l" href="{-url:custom_model/list_content?custom_model_id={$_CMI['custom_model_id']}-}"><i class="icon icon-list"></i> {-:@LIST-}</a></span></dt>
	<dd>
		<form id="formEdit" class="form" action="{-url:custom_model/edit_content_do-}" method="post">
			{-:$_FI-}
