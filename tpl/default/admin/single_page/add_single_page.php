...
<dl class="abox">
	<dt><strong>{-:@ADD_SINGLE_PAGE-}</strong></dt>
	<dd>
		<table class="formTable">
			...
			<tr>
				<td class="inputArea">
					<input class="i" type="text" value="default" name="sp_group" maxlength="32" size="16"> <span class="fc_gry">{-:@SP_GROUP_TIP-}</span>
				</td>
				<td class="inputArea">
					<input class="i" type="text" value="50" name="sp_display_order" maxlength="10" size="4"> <span class="fc_gry">{-:@SP_DISPLAY_ORDER_TIP-}</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="inputArea">
					<label><input type="radio" value="0" name="sp_is_html"> {-:@OFF-}</label>
					<label><input type="radio" value="1" name="sp_is_html" checked="checked"> {-:@ON-}</label>
				</td>
				<td class="inputArea">
			...
			<tr>
				<td class="inputArea">
					<input id="sp_tpl" class="required i" type="text" value="show_single_page" name="sp_tpl" maxlength="96" size="30"> <span class="btn_l choose_template" base_dir="home" to_id="sp_tpl">{-:@CHOOSE-}</span>
				</td>
				<td class="inputTip">
...
<div id="operation">
	...
	<span class="btn_b submit" action="{-url:single_page/add_single_page_do-}" to="#formAdd">{-:@SUBMIT-}</span>
