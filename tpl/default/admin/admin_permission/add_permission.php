...
<dl class="abox">
	<dt><strong>{-:@ADD_ADMIN_PERMISSION-}</strong></dt>
	<dd>
		<table class="formTable">
			...
			<tr>
				<td class="inputArea">
					<input class="required i" type="text" value="" name="ap_group" maxlength="96" size="20">
				</td>
				<td class="inputTip">
			...
			<tr>
				<td class="inputArea">
					<input class="required i" type="text" value="" name="ap_name" maxlength="96" size="20">
				</td>
				<td class="inputTip">
...
<div id="operation">
	...
	<span class="btn_b submit" action="{-url:admin_permission/add_permission_do-}" to="#formAdd">{-:@SUBMIT-}</span>
