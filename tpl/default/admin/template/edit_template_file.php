...
<dl class="abox">
	<dt><strong>{-:@EDIT_TEMPLATE_FILE-}</strong></dt>
	<dd>
		<table class="formTable">
			...
			<tr>
				<td class="inputArea">
					<label><strong>{-:@TEMPLATE_FILE-}</strong> {-:$_V['file']-}<input class="i required" type="hidden" value="{-:$_V['file']-}" name="file" /></label>
...
<div id="operation">
	...
	<span class="btn_b submit" action="{-url:template/edit_template_file_do-}" to="#formAdd">{-:@SUBMIT-}</span>
