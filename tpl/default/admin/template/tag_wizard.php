...
<dl class="atab">
	...
	<dd>
		...
		<div class="tabCntnt">
			...
			<table class="listTable">
				{-include:tag_wizard/ad-}
{-include:tag_wizard/fl_list-}
{-include:tag_wizard/gb_list-}
{-include:tag_wizard/menu-}
{-include:tag_wizard/sp_list-}
{-include:tag_wizard/tag_list-}
{-include:tag_wizard/vote-}
