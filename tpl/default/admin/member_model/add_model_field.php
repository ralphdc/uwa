...
<dl class="abox">
	...
	<dd>
		<table id="main_params" class="formTable">
			...
			<tr>
				<td class="inputArea">
					<textarea class="i" name="f_default" style="width:240px;height:60px;"></textarea>
				</td>
				<td class="inputTip">
					{-:@F_DEFAULT_TIP-}
				</td>
			...
			<tr>
				<td class="inputArea">
					<label><input type="radio" name="f_is_registration" value="1"> {-:@ON-}</label>
					<label><input type="radio" name="f_is_registration" checked="checked" value="0"> {-:@OFF-}</label>
				</td>
				<td class="inputTip">
...
<div id="operation">
	...
	<input type="hidden" value="{-:$_MMI['member_model_id']-}" name="member_model_id">
	<span class="btn_b submit" action="{-url:member_model/add_model_field_do-}" to="#formAdd">{-:@SUBMIT-}</span>
	<input class="btn_l" type="reset" value="{-:@RESET-}" />
	<a class="btn_l" href="{-url:member_model/edit_model?member_model_id={$_MMI['member_model_id']}-}">{-:@BACK-}</a>
