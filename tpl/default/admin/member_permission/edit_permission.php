...
<dl class="abox">
	<dt><strong>{-:@EDIT_MEMBER_PERMISSION-}</strong></dt>
	<dd>
		<table class="formTable">
			...
			<tr>
				<td class="inputArea">
					<input class="required i" type="text" value="{-:$_MPI['mp_group']-}" name="mp_group" maxlength="96" size="20">
				</td>
				<td class="inputTip">
					<span class="fc_r">*</span> <span class="fc_gry">{-:@MP_GROUP_TIP-}</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="inputArea">
					<input class="required i" type="text" value="{-:$_MPI['mp_name']-}" name="mp_name" maxlength="96" size="20">
				</td>
				<td class="inputTip">
					<span class="fc_r">*</span> <span class="fc_gry">{-:@MP_NAME_TIP-}</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="inputTip">
					<span class="fc_r">*</span> <span class="fc_gry">{-:@MP_CONTENT_TIP-}</span>
				</td>
			</tr>
		</table>
	</dd>
...
<div id="operation">
	...
	<input type="hidden" value="{-:$_MPI['member_permission_id']-}" name="member_permission_id">
	<span class="btn_b submit" action="{-url:member_permission/edit_permission_do-}" to="#formEdit">{-:@SUBMIT-}</span>
	<input class="btn_l" type="reset" value="{-:@RESET-}" />
	<a class="btn_l" href="{-url:member_permission/list_permission-}">{-:@BACK-}</a>
</div>
</form>
...
function get_actnList(ctrlr) {
	$('#actn').html('');
	$.getJSON('{-url:member_permission/get_actnList-}'+'&'+Math.random(),{ctrlr:ctrlr},function(data) {
