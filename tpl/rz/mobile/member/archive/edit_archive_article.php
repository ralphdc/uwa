	...
	<dd>
		<form id="formEdit" class="form" action="{-url:archive/edit_archive_do-}" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input class="control-input" type="text" value="{-:$_AI['a_a_source']-}" name="a_a_source" maxlength="96" size="20" />
			</div>
			<div class="form-group">
				<label class="control-label">{-:@AUTHOR-}</label>
				<input class="control-input" type="text" value="{-:$_AI['a_a_author']-}" name="a_a_author" maxlength="96" size="20" />
			</div>
			{-:$_FI-}
