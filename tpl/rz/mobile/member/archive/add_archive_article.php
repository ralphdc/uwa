...
<dl class="adl margin-top-sm">
	<dt><h5><i class="icon icon-plus"></i> {-:@PUBLISH-} {-:$_AI['am_name']-}</h5><span class="float-right"><a class="btn_l" href="{-url:archive/list_archive?archive_model_id={$_AI['archive_model_id']}-}"><i class="icon icon-list"></i> {-:@LIST-}</a></span></dt>
	<dd>
		<form id="formAdd" class="form" action="{-url:archive/add_archive_do-}" method="post" enctype="multipart/form-data">
			<div class="form-group">
				<label class="control-label">{-:@TITLE-}</label>
				<input required="required" type="text" name="a_title" value="" class="control-input" maxlength="255">
			</div>
			<div class="form-group">
				<label class="control-label">{-:@COST_POINTS-}</label>
				<input required="required" type="text" name="a_cost_points" value="0" class="control-input" maxlength="8">
			</div>
			<div class="form-group">
			...
			{-else:-}
				<input class="control-input" type="text" value="" name="a_thumb" maxlength="255" size="50" placeholder="http://" />
				<div class="control-help">{-:@A_THUMB_URL_TIP-}</div>
			{-:/if-}
			</div>
			<div class="form-group">
				<label class="control-label">{-:@KEYWORDS-}</label>
				<input class="control-input" type="text" value="" name="a_keywords" maxlength="255" size="50" />
				<div class="control-help">{-:@A_KEYWORDS_TIP-}</div>
			</div>
			<div class="form-group">
				<label class="control-label">{-:@DESCRIPTION-}</label>
				<textarea class="control-input" name="a_description" style="height:60px;"></textarea>
				<div class="control-help">{-:@A_DESCRIPTION_TIP-}</div>
			</div>
			<div class="form-group">
				<label class="control-label">{-:@SOURCE-}</label>
				<input class="control-input" type="text" value="" name="a_a_source" maxlength="96" size="20" />
			</div>
			<div class="form-group">
				<label class="control-label">{-:@AUTHOR-}</label>
				<input class="control-input" type="text" value="{-:+m_username-}" name="a_a_author" maxlength="96" size="20" />
			</div>
			{-:$_FI-}
