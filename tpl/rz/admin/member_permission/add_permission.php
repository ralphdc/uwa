...
<dl class="abox">
	<dt><strong>{-:@ADD_MEMBER_PERMISSION-}</strong></dt>
	<dd>
		<table class="formTable">
			...
			<tr>
				<td class="inputArea">
					<input class="required i" type="text" value="" name="mp_group" maxlength="96" size="20">
				</td>
				<td class="inputTip">
			...
			<tr>
				<td class="inputArea">
					<input class="required i" type="text" value="" name="mp_name" maxlength="96" size="20">
				</td>
				<td class="inputTip">
...
<div id="operation">
	...
	<span class="btn_b submit" action="{-url:member_permission/add_permission_do-}" to="#formAdd">{-:@SUBMIT-}</span>
