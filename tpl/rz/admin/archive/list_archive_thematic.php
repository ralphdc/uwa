	...
	<dd>
		<table class="listTable">
			<tr>
				...
				<th scope="col">{-:@ID-}</th>
				<th scope="col" width="160">{-:@THUMB-}</th>
			...
			<tr>
				...
				<td>{-:$a['archive_id']-}</td>
				<td>
					<img src="{-:$a['a_thumb']-}" width="160" />
				</td>
				<td>
					<a href="{-url:archive/edit_archive?archive_id={$a['archive_id']}-}">{-:$a['a_title']-}</a> {-:$a['af_alias']|get_archiveFlag~@me,2-}
					<br /><span class="fs_12 fc_gry"><strong>{-:@CHANNEL-}</strong>: <a href="{-url:archive/list_archive?archive_channel_id={$a['archive_channel_id']}-}">{-:$a['ac_name']-}</a></span>
				</td>
				<td>
