	...
	<dd>
		<table class="listTable">
			...
			<tr>
				...
				<td>
				{-if:'code' == $as['as_type']-}{-:@CODE-}
				{-elseif:'text' == $as['as_type']-}{-:@TEXT-}
				{-elseif:'image' == $as['as_type']-}{-:@IMAGE-}
				{-elseif:'flash' == $as['as_type']-}{-:@FLASH-}
				{-elseif:'slide' == $as['as_type']-}{-:@SLIDE-}
				{-elseif:'banner' == $as['as_type']-}{-:@BANNER-}
				{-elseif:'rolls' == $as['as_type']-}{-:@ROLLS-}
				{-:/if-}
				</td>
				<td>{-if:'code' == $as['as_type']-}{-:@CODE-}{-elseif:'text' == $as['as_type']-}{-:@TEXT-}{-elseif:'image' == $as['as_type']-}{-:@IMAGE-}{-elseif:'flash' == $as['as_type']-}{-:@FLASH-}{-elseif:'slide' == $as['as_type']-}{-:@SLIDE-}{-elseif:'banner' == $as['as_type']-}{-:@BANNER-}{-elseif:'rolls' == $as['as_type']-}{-:@ROLLS-}{-:/if-}</td>
				<td>
				{-if:1 == $as['as_status']-}
