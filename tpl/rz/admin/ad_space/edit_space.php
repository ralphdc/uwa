		...
		<table class="formTable">
			...
			<tr>
				<td class="inputArea">
					...
					<label><input type="radio" value="banner" name="as_type" {-if:'banner' == $_ASI['as_type']-} checked="checked"{-:/if-}> {-:@BANNER-}</label>
					<label><input type="radio" value="rolls" name="as_type" {-if:'roll' == $_ASI['as_type']-} checked="checked"{-:/if-}> {-:@ROLLS-}</label>
				</td>
				<td class="inputTip">
