...
{-if:is_array($_fi['params']['f_default'])-}
	{-foreach:$_fi['params']['f_default'],$k,$_pfd-}<p>
		...
		{-if:1 == $_fi['params']['f_browse_server']-}
			<span id="{-:$_fi['tag']-}_{-:$k-}_finder" to="#{-:$_fi['tag']-}_{-:$k-}" typeset="image" class="btn_l finder">{-:@BROWSE_SERVER-}</span>
		{-:/if-}
	</p>{-:/foreach-}
{-else:-}
	{-if:1 == $_fi['params']['f_multi_upload']-}
		...
		{-if:1 == $_fi['params']['f_browse_server']-}
			<span id="{-:$_fi['tag']-}_finder" to="#{-:$_fi['tag']-}" multi_upload="yes" typeset="image" class="btn_l finder">{-:@BROWSE_SERVER-}</span>
		{-:/if-}
	{-else:-}
		...
		{-if:1 == $_fi['params']['f_browse_server']-}
			<span id="{-:$_fi['tag']-}_finder" to="#{-:$_fi['tag']-}" typeset="image" class="btn_l finder">{-:@BROWSE_SERVER-}</span>
		{-:/if-}
	{-:/if-}
{-:/if-}
</td></tr>
