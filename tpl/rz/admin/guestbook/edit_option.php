...
<dl class="abox">
	<dt><span><a href="{-url:guestbook/list_guestbook-}">{-:@GUESTBOOK_LIST-}</a></span><strong>{-:@GUESTBOOK_OPTION-}</strong></dt>
	<dd>
		<div class="tabCntnt">
			<table id="main_params" class="formTable">
				<tr>
					<td class="inputTitle">{-:@GUESTBOOK_SWITCH-}</td>
					<td class=""></td>
				</tr>
				<tr>
					<td class="inputArea">
					...
					<td class="inputTip">
						<span class="fc_r">*</span> {-:@GUESTBOOK_SWITCH_TIP-}
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="inputTip">
						<span class="fc_r">*</span> {-:@GUESTBOOK_PAGE_SIZE_TIP-}
					</td>
				</tr>
			</table>
		</div><!--/.tabCntnt-->
...
<div id="operation">
	...
	<span class="btn_b submit" action="{-url:guestbook/edit_option_do-}" to="#formEdit">{-:@SUBMIT-}</span>
