...
<dl class="abox">
	...
	<dd>
		<table class="formTable">
			...
			<tr>
				<td class="inputArea">
					<input class="required i" type="text" value="" name="f_site_name" maxlength="96" size="30">
				</td>
				<td class="inputTip">
			...
			<tr>
				<td class="inputArea">
					<input class="required i" type="text" value="http://" name="f_site_url" maxlength="96" size="30">
				</td>
				<td class="inputTip">
			...
			<tr>
				<td class="inputArea">
					<input class="i" type="text" value="" name="f_webmaster_email" maxlength="96" size="30">
				</td>
				<td class="inputTip">
			...
			<tr>
				<td class="inputArea">
					<textarea class="i" name="f_site_description" style="width:360px;height:60px;"></textarea>
				</td>
				<td class="inputTip">
			...
			<tr>
				<td class="inputArea">
					<input id="f_site_log" class="i" type="text" value="" name="f_site_logo" maxlength="255" size="50">
				...
				<td class="inputArea">
					<img id="f_site_logo_preview" src="" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="inputArea">
					<label><input type="radio" value="0" name="f_show_type" checked="checked"> {-:@TEXT_LINK-}</label>
					<label><input type="radio" value="1" name="f_show_type"> {-:@LOGO_LINK-}</label>
				</td>
				<td class="inputArea">
			...
			<tr>
				<td class="inputArea">
					<label><input type="radio" value="0" name="f_status"> {-:@NOT_PASSED-}</label>
					<label><input type="radio" value="1" name="f_status" checked="checked"> {-:@PASSED-}</label>
				</td>
				<td class="inputArea">
			...
			<tr>
				<td class="inputArea">
					<input class="i" type="text" value="50" name="f_display_order" maxlength="20" size="10">
				</td>
				<td class="inputArea">
...
<div id="operation">
	...
	<span class="btn_b submit" action="{-url:flink/add_flink_do-}" to="#formAdd">{-:@SUBMIT-}</span>
