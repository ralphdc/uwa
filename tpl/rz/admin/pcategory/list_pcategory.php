...
<dl class="abox">
	<dt><strong>{-:@PCATEGORY_PAGE_LIST-}</strong></dt>
	<dd>
		<table class="listTable">
			...
			{-foreach:$_SPL,$sp-}
			<tr>
				<td><input name="pcategory_id[{-:$sp['pcategory_id']-}]" type="checkbox" value="{-:$sp['pcategory_id']-}"></td>
				<td><input type="text" class="i required" size="6" maxlength="10" name="sp_display_order[{-:$sp['pcategory_id']-}]" value="{-:$sp['pcategory_id']-}"></td>
				<td>{-:$sp['pcategory_id']-}</td>
