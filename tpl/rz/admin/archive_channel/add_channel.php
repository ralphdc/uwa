	...
	<dd>
			...
			<table class="formTable">
				...
				<tr>
					<td colspan="2" class="inputArea">
						...
						<label><input type="checkbox" value="1" name="pinyin_as_dirname" checked="checked" /> {-:@PINYIN_AS_DIRNAME-}</label>
					</td>
					</tr>
				<tr>
		...
		<div class="tabCntnt">
			<table class="formTable">
				...
				<tr>
					<td class="inputArea">
						<textarea class="i" name="ac_keywords" style="width:360px;height:40px;"></textarea> <span class="fc_gry">{-:@AC_KEYWORDS_TIP-}</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="inputArea">
						<textarea class="i" name="ac_description" style="width:360px;height:60px;"></textarea> <span class="fc_gry">{-:@AC_DESCRIPTION_TIP-}</span>
					</td>
				</tr>
				<tr>
...
<div id="operation">
	...
	<span class="btn_b submit" action="{-url:archive_channel/add_channel_do-}" to="#formAdd">{-:@SUBMIT-}</span>
...
var type_desc_all = '{-:@FILE-}', file_type_exts_all = '{-:$_OU['all']-}',
	...
	uploader_image = '{-url:upload/upload_file?typeset=image&upload_type=channel-}',
