...
<div id="operation">
	...
	<input type="hidden" value="{-:$_AMI['archive_model_id']-}" name="archive_model_id">
	<span class="btn_b submit" action="{-url:archive_model/add_model_field_do-}" to="#formAdd">{-:@SUBMIT-}</span>
	<input class="btn_l" type="reset" value="{-:@RESET-}" />
	<a class="btn_l" href="{-url:archive_model/edit_model?archive_model_id={$_AMI['archive_model_id']}-}">{-:@BACK-}</a>
...
<table id="extra_params" style="display:none;">
	...
	<tr params_for="htmltext">
		<td class="inputArea">
			<label><input type="radio" name="f_get_thumb" value="1"> {-:@ON-}</label>
			<label><input type="radio" name="f_get_thumb" checked="checked" value="0"> {-:@OFF-}</label>
		</td>
		<td class="inputTip">
	...
	<tr params_for="htmltext">
		<td class="inputArea">
			<label><input type="radio" name="f_get_abstract" value="1"> {-:@ON-}</label>
			<label><input type="radio" name="f_get_abstract" checked="checked" value="0"> {-:@OFF-}</label>
		</td>
		<td class="inputTip">
