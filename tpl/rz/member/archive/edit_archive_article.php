		...
		<dl class="atab_1 adiv">
			...
			<dd class="p_20">
				<form id="formEdit" action="{-url:archive/edit_archive_do-}" method="post" enctype="multipart/form-data"><table class="formTable">
					...
					<tr>
						<td colspan="2" class="inputArea">
							<label>{-:@SOURCE-} <input id="a_a_source" class="i" type="text" value="{-:$_AI['a_a_source']-}" name="a_a_source" maxlength="96" size="20"></label>
							<label>{-:@AUTHOR-} <input id="a_a_author" class="i" type="text" value="{-:$_AI['a_a_author']-}" name="a_a_author" maxlength="96" size="20"></label>
						</td>
					</tr>
					{-:$_FI-}
