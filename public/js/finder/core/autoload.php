...
if(!defined('FINDER_PATH')) {
	define('FINDER_PATH', dirname(dirname(__FILE__)));
}
if(!defined('D_S')) {
...
if(isset($_GET['cms'])) {
	switch ($_GET['cms']) {
		case "drupal":
			require FINDER_PATH . D_S . "integration/drupal.php";
			break;
	}
}
...
if(!function_exists("__autoload")) {
	function __autoload($class) {
		if(file_exists(FINDER_PATH . D_S . "core/$class.class.php")) {
			require FINDER_PATH . D_S . "core/$class.class.php";
		}
		elseif(file_exists(FINDER_PATH . D_S . "core/types/$class.class.php")) {
			require FINDER_PATH . D_S . "core/types/$class.class.php";
		}
		elseif(file_exists(FINDER_PATH . D_S . "lib/$class.class.php")) {
			require FINDER_PATH . D_S . "lib/$class.class.php";
		}
	}
}
