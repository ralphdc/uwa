<?php /* @desc Miscellaneous functionality */ ?>
...
browser.showAlert = function(shadow) {
	...
	if(typeof shadow == 'undefined' || null == shadow)
		shadow = true;
	if(shadow)
		this.shadow();
...
browser.baseGetData = function(act) {
	var data = '<?php echo $config["browse_url"]; ?>type=' + encodeURIComponent(this.type) + '&lng=' + this.lang;
	if(act)
		data += "&act=" + act;
	if(this.cms)
		data += "&cms=" + this.cms;
