<?php /* @desc Upload files using drag and drop */ ?>

browser.initDropUpload = function() {
	if((typeof(XMLHttpRequest) == 'undefined' || null == XMLHttpRequest) ||
		(typeof(document.addEventListener) == 'undefined' || null == document.addEventListener) ||
		(typeof(File) == 'undefined' || null == File) ||
