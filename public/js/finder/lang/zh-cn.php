...
// SINCE 2.4
"Checking for new version..." => "检查新版本...",
"Unable to connect!" => "连接失败!",
"Download version {version} now!" => "立即下载 {version} 版本！",
"KCFinder is up to date!" => "KCFinder 已是最新版本!",
"Licenses:" => "许可证:",
"Attention" => "注意",
"Question" => "提问",
"Yes" => "是",
...
"上传文件 第{number}个/共{count}个... {progress}",

"Failed to upload {filename}!" => "上传 {filename} 失败！",

// UWA
"File size is out of limit." => "文件大小超出限制。",
);
