...
/**
 *--------------------------------------
 * PHPMailer 5.2.2 - PHP email class
 *--------------------------------------
 * @project		: uwa
 * @author		: https://code.google.com/a/apache-extras.org/p/phpmailer/
 * @created		: 2014-09-30
...
class PHPMailer {
	...
	* If not empty, and ReturnPath is empty, will also be the Return-Path header. */
	public $Sender = '';
	...
	* This body can be read by mail clients that do not have HTML email capability such as mutt. Clients
	* that can read HTML will view the normal Body. */
	...
	/* Sets word wrapping on the body of the message to a given number of characters. @var int */
	public $WordWrap = 0;
	...
	/* Determine if mail() uses a fully sendmail compatible MTA that supports sendmail's "-oi -f" options. @var boolean */
	...
	* If empty, the current date will be added. */
	...
	/* Sets the SMTP hosts.
	* All hosts must be separated by a semicolon. You can also specify a different port for each host by using this format: [hostname:port]
	...
	* Hosts will be tried in order. */
	...
	/* Sets SMTP authentication. Utilizes the Username and Password variables. @var bool */
	...
	/* Sets SMTP auth type. Options are LOGIN | PLAIN | NTLM  (default LOGIN) @var string */
	public $AuthType = '';

	/* Sets SMTP realm. @var string */
	public $Realm = '';

	/* Sets SMTP workstation. @var string */
	public $Workstation = '';
	...
	* This function will not work with the win32 version. */
	...
	/* Sets SMTP class debugging on or off. @var bool */
	...
	* @var string NULL for default, whitespace for None, or actual string to use */
	...
	/* Calls actual mail() function, but in a safe_mode aware fashion Also, unless sendmail_path points to sendmail (or something that
	* claims to be sendmail), don't pass params (not a perfect fix, but it will do)
	* @param string $to To
