...
define('SOFT_AUTHOR', 'rzpackage.com');
// define('SOFT_AUTHOR_URL', 'http://uwa2x.rzpackage.com/');
// define('SOFT_OFFICIAL_FORUM_URL', 'http://bbs.rzpackage.com/');
// define('SOFT_ONLINE_MANUAL_URL', 'http://help.rzpackage.com/');
// define('SOFT_UPGRADE_URL', 'http://upgrade.rzpackage.com/uwa2x/upgrade-info.js');
// define('SOFT_AUTHORIZATION_URL', 'http://ac.rzpackage.com/');
// define('SOFT_AUTHORIZATION_URL', 'http://ac.rzpackage.com/');
