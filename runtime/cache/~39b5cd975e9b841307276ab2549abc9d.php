<?php /* PFA Template Cache File. Create Time:2015-06-06 15:10:16 */ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
<link rel="stylesheet" type="text/css" href="/tpl/rz/admin/css/i.css" />
</head>
<body>
	...
	<dl>
		...
		<dd>
			<ul>
				...
				<li><label><span class="btn_l" value="" onclick="check_screenlock();return false;"><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/unlock.png" /> <?php echo(L("UNLOCK")); ?></span></label></li>
			</ul>
		</dd>
	</dl>
</div><!--/#screenLock-->
<div id="header">
	...
	<div id="statusInfo">
		<ul>
			...
			<li id="_M0" class="top a" url="<?php echo(Url::U("index/show_system_info")); ?>"><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/information.png" /> <?php echo(L("SYSTEM_INFO")); ?></li>
			<li class="top"><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/globe.png" /> <a href="<?php echo(Url::U("home@index/index")); ?>" target="_blank"><?php echo(L("VIEW_SITE")); ?></a></li>
			<li class="top"><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/logout.png" /> <a href="<?php echo(Url::U("login/logout_do")); ?>"><?php echo(L("LOGOUT")); ?></a></li>
			<li class="top"><span id="screenLockSwitch" class="a fw_b fc_g"><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/screen_lock.png" /> <?php echo(L("LOCK_SCREEN")); ?></span></li>
			<li id="shortcutSwitch" class="top a">
				<div><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/shortcut.png" /> <?php echo(L("SHORTCUT")); ?></div>
				<ul id="shortcutItems">
					<?php if(isset($_SL) and is_array($_SL)) : foreach($_SL as $s) : ?><li url="<?php echo($s['shortcut_url']); ?>" class="a">
						<img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/<?php echo($s['shortcut_icon']); ?>.png" /> <?php echo($s['shortcut_title']); ?>
	...
	<div id="positionBar">
		<div id="menuControl">
			<span class="a" id="topbarSwitch"><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/toggle_topbar.png" /> <?php echo(L("TOGGLE_TOPBAR")); ?></span>
			<span class="a" id="sidebarSwitch"><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/toggle_sidebar.png" /> <?php echo(L("TOGGLE_SIDEBAR")); ?></span>
			<span class="a" id="operationMapSwitch"><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/operation_map.png" /> <?php echo(L("OPERATION_MAP")); ?></span>
		</div>
		<div id="position"></div><!--/#position-->
		<div id="official_link"><a href="<?php echo(SOFT_OFFICIAL_FORUM_URL); ?>" target="_blank"><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/balloon.png" /> <?php echo(L("OFFICIAL_FORUM")); ?></a> <a href="<?php echo(SOFT_ONLINE_MANUAL_URL); ?>" target="_blank"><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/lifebuoy.png" /> <?php echo(L("HELP_MANUAL")); ?></a></div>
	</div><!--/#positionBar-->
</div><!--/#header-->
<div id="sidebar">
	...
	<dl id="<?php echo($m['m_sub_key']); ?>" class="t subMenu">
		...
		<dt class="a"><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/<?php echo($ms['m_alias']); ?>.png" /> <?php echo($ms['m_group_name']); ?></dt>
		<dd>
			<ul>
				<?php if(isset($ms['m_menus']) and is_array($ms['m_menus'])) : foreach($ms['m_menus'] as $menu) : ?>
				<li class="a" url="<?php echo($menu['m_url']); ?>"><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/<?php echo($menu['m_alias']); ?>.png" /> <?php echo($menu['m_name']); ?></li>
...
<dl class="mapTop">
	...
	<dd>
		<?php if(isset($m['m_sub']) and is_array($m['m_sub'])) : foreach($m['m_sub'] as $ms) : ?>
		<dl class="mapItem">
			<dt><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/<?php echo($ms['m_alias']); ?>.png" /> <?php echo($ms['m_group_name']); ?></dt>
			<dd>
			<ul class="item">
				<?php if(isset($ms['m_menus']) and is_array($ms['m_menus'])) : foreach($ms['m_menus'] as $menu) : ?>
				<li class="a" url="<?php echo($menu['m_url']); ?>" target="mainiFrame"><img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/<?php echo($menu['m_alias']); ?>.png" /> <?php echo($menu['m_name']); ?></li>
				<?php endforeach; endif; ?>
			</ul>
			</dd>
		</dl>
...
<script src="/tpl/rz/admin/js/i.js"></script>
</body>
</html>