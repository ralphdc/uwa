<?php /* PFA Template Cache File. Create Time:2015-06-06 15:10:17 */ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
			...
			<dd>
				<ul class="aul_1">
					<?php if(isset($_SL) and is_array($_SL)) : foreach($_SL as $s) : ?><li>
						<img class="mi mi_16" src="/tpl/rz/admin/img/mi_16/<?php echo($s['shortcut_icon']); ?>.png" /> <a href="<?php echo($s['shortcut_url']); ?>"><?php echo($s['shortcut_title']); ?></a>
