<?php /* PFA Template Cache File. Create Time:2015-06-06 23:01:11 */ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
<dl class="abox">
	<dt><strong><?php echo(L("ADD_MENU")); ?></strong></dt>
	<dd>
		<table class="formTable">
			...
			<tr>
				<td class="inputArea">
					...
					<?php if(isset($_MSL) and is_array($_MSL)) : foreach($_MSL as $ms) : ?>
						<option value="<?php echo($ms['ms_alias']); ?>"><?php echo($ms['ms_name']); ?></option>
			...
			<tr>
				<td class="inputArea">
					<input id="m_name" class="required i" type="text" value="" name="m_name" maxlength="96" size="30"> <span class="fc_r">*</span> <span class="fc_gry"><?php echo(L("M_NAME_TIP")); ?></span>
				</td>
				<td class="inputArea">
					<input class="i" type="text" value="" name="m_tip" id="m_tip" maxlength="255" size="50"> <span class="fc_gry"><?php echo(L("M_TIP_TIP")); ?></span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" class="inputArea">
					<input class="required i" type="text" value="" name="m_url" id="m_url" maxlength="255" size="90"> <span class="fc_r">*</span> <span class="fc_gry"><?php echo(L("M_URL_TIP")); ?></span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="inputArea">
					<label><input id="compose_btn" type="radio" onclick="$('#compose_url').show();" value="0" name="m_type"> <?php echo(L("COMPOSE")); ?></label>
					<label><input type="radio" onclick="$('#compose_url').hide();" checked="checked" value="1" name="m_type"> <?php echo(L("DIRECT")); ?></label> <span class="fc_r">*</span> <span class="fc_gry"><?php echo(L("M_TYPE_TIP")); ?></span>
				</td>
				<td class="inputTip">
					<input class="required i" type="text" value="50" name="m_display_order" maxlength="20" size="10"> <span class="fc_r">*</span> <span class="fc_gry"><?php echo(L("M_DISPLAY_ORDER_TIP")); ?></span>
				</td>
			</tr>
			...
			<tr>
				<td class="inputArea">
					...
					<select id="m_target_select" onchange="$('#m_target').val($('#m_target_select').val());">
						...
						<option value="_self"><?php echo(L("SELF_WINDOW")); ?></option>
						<option value="_blank"><?php echo(L("NEW_WINDOW")); ?></option>
						<option value="_parent"><?php echo(L("PARENT_FRAME")); ?></option>
						<option value="_top"><?php echo(L("TOP_FRAME")); ?></option>
...
<div id="operation">
	...
	<span class="btn_b submit" action="<?php echo(Url::U("menu/add_menu_do")); ?>" to="#formAdd"><?php echo(L("SUBMIT")); ?></span>
