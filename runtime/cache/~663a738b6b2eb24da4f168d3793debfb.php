...
?> </div> <div class="center"> <div class="main"> <div class="crumbs"><a href="#">首页</a> > 最新资讯</div> <div class="list"> <h2>最新资讯</h2> <div class="dynamic_box"> <ol> <?php if(isset($_L) and is_array($_L)) : foreach($_L as $k => $item) : ?> <?php if($k < 3) :  ?> <li> <p><a href="<?php echo($item['a_url']); ?>"><img class="a" src="<?php echo($item['a_thumb']); ?>" /></a></p> <h3><a href="<?php echo($item['a_url']); ?>"><?php echo($item['a_title']); ?></a> </h3> <p class="a_publish_date ta_r fc_gry fs_12 fw_n"><?php echo(L("PUBLISH_DATE")); ?>: <?php echo(date('m-d', $item['a_edit_time'])); ?></p> <p><?php echo(L("CHANNEL")); ?>: <a href="<?php echo($item['ac_url']); ?>"><?php echo($item['ac_name']); ?></a> <?php echo(L("VIEW")); ?>: <span class="fc_gry"><?php echo($item['a_view_count']); ?></span> <p class="a_description fc_gry"><?php echo($item['a_description']); ?></p> </li> <?php else : ?> <li>         					[<a href="<?php echo($item['ac_url']); ?>"><?php echo($item['ac_name']); ?></a>] <a class="fc_gry_d" href="<?php echo($item['a_url']); ?>"><?php echo(AString::utf8_substr($item['a_title'], 60)); ?></a> <span class="fc_gry"><?php echo(date('m-d', $item['a_edit_time'])); ?></span> </li> <?php endif; ?> <?php endforeach; endif; ?> <li> <img src="images/img8.jpg" /> <h3><a href="dynamicinfo.html">标题标题标题标题标题标题标题标题标题标题</a></h3> <p>文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述文字描述...</p> <em>[2015-02-02]</em> <a class="more" href="dynamicinfo.html">更多详情 >></a> </li> </ol> <?php if(!empty($PAGING)) :  ?> <div id="page_list"> <!--first page--> <?php if(!empty($PAGING['firstPage']['url'])) :  ?> <a href="<?php echo($PAGING['firstPage']['url']); ?>" class="firstPage"><?php echo(L("_FIRST_PAGE_")); ?></a> <?php else : ?> <span class="firstPage"><?php echo(L("_FIRST_PAGE_")); ?></span> <?php endif; ?> <!--prev page--> <?php if(!empty($PAGING['prevPage']['url'])) :  ?> <a href="<?php echo($PAGING['prevPage']['url']); ?>" class="prevPage"><?php echo(L("_PREV_PAGE_")); ?></a> <?php else : ?> <span class="prevPage"><?php echo(L("_PREV_PAGE_")); ?></span> <?php endif; ?> <!--near prev page--> <?php if(!empty($PAGING['nearPrevPage'])) :  ?> <?php if(isset($PAGING['nearPrevPage']) and is_array($PAGING['nearPrevPage'])) : foreach($PAGING['nearPrevPage'] as $npp) : ?> <a href="<?php echo($npp['url']); ?>" class="nearPage"><?php echo($npp['page']); ?></a> <?php endforeach; endif; ?> <?php endif; ?> <!--current page--> <?php if(!empty($PAGING['currentPage'])) :  ?> <span class="currentPage"><?php echo($PAGING['currentPage']['page']); ?></span> <?php endif; ?> <!--near next page--> <?php if(!empty($PAGING['nearNextPage'])) :  ?> <?php if(isset($PAGING['nearNextPage']) and is_array($PAGING['nearNextPage'])) : foreach($PAGING['nearNextPage'] as $nnp) : ?> <a href="<?php echo($nnp['url']); ?>" class="nearPage"><?php echo($nnp['page']); ?></a> <?php endforeach; endif; ?> <?php endif; ?> <!--next page--> <?php if(!empty($PAGING['nextPage']['url'])) :  ?> <a href="<?php echo($PAGING['nextPage']['url']); ?>" class="nextPage"><?php echo(L("_NEXT_PAGE_")); ?></a> <?php else : ?> <span class="nextPage"><?php echo(L("_NEXT_PAGE_")); ?></span> <?php endif; ?> <!--last page--> <?php if(!empty($PAGING['lastPage']['url'])) :  ?> <a href="<?php echo($PAGING['lastPage']['url']); ?>" class="lastPage"><?php echo(L("_LAST_PAGE_")); ?></a> <?php else : ?> <span class="lastPage"><?php echo(L("_LAST_PAGE_")); ?></span> <?php endif; ?> <!--total info--> <span class="total"><?php echo(L("_TOTAL_PAGES_")); ?>:<?php echo($PAGING['totalPages']); ?> | <?php echo(L("_TOTAL_ROWS_")); ?>:<?php echo($PAGING['totalRows']); ?></span> </div> <?php endif; ?> </div> </div> </div> </div> <div class="m w_960"> <div class="w_650 f_l"> <div> <?php
$var_asi = '_asi_2';
