<?php /* PFA Template Cache File. Create Time:2015-06-06 10:46:00 */ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
	...
	<dd>
		<table class="listTable">
			...
			<tr>
				...
				<td><?php if('code' == $as['as_type']) :  ?><?php echo(L("CODE")); ?><?php elseif('text' == $as['as_type']) :  ?><?php echo(L("TEXT")); ?><?php elseif('image' == $as['as_type']) :  ?><?php echo(L("IMAGE")); ?><?php elseif('flash' == $as['as_type']) :  ?><?php echo(L("FLASH")); ?><?php elseif('slide' == $as['as_type']) :  ?><?php echo(L("SLIDE")); ?><?php endif; ?></td>
				<td>
