<?php /* PFA Template Cache File. Create Time:2015-06-06 18:08:20 */ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
<dl class="abox">
	<dt><strong><?php echo(L("ADD_AD")); ?></strong></dt>
	<dd>
		<table class="formTable">
			...
			<tr>
				<td class="inputArea">
					<?php if('code' == $_ASI['as_type']) :  ?><?php echo(L("CODE")); ?><?php endif; ?>
					<?php if('text' == $_ASI['as_type']) :  ?><?php echo(L("TEXT")); ?><?php endif; ?>
					<?php if('image' == $_ASI['as_type']) :  ?><?php echo(L("IMAGE")); ?><?php endif; ?>
					<?php if('flash' == $_ASI['as_type']) :  ?><?php echo(L("FLASH")); ?><?php endif; ?>
					<?php if('slide' == $_ASI['as_type']) :  ?><?php echo(L("SLIDE")); ?><?php endif; ?>
					<?php if('banner' == $_ASI['as_type']) :  ?><?php echo(L("BANNER")); ?><?php endif; ?>
					<?php if('rolls' == $_ASI['as_type']) :  ?><?php echo(L("ROLLS")); ?><?php endif; ?>
				</td>
				<td class="inputTip">
			...
			<tr <?php if('code' == $_ASI['as_type'] or 'text' == $_ASI['as_type']) :  ?> style="display:none"<?php endif; ?>>
			...
			<tr id="a_content">
				<td colspan="2" class="inputArea">
					...
					<textarea class="i <?php if('code' != $_ASI['as_type']) :  ?>editor<?php endif; ?>" name="a_content" style="width:450px;height:120px;"></textarea>
				</td>
			</tr>
			<?php if(1 != $_AI['as_type']) :  ?><tr>
			...
			<tr>
				<td class="inputArea">
					<label><input type="radio" value="0" name="a_time_limit" checked="checked"> <?php echo(L("NOT_LIMIT")); ?></label>
					<label><input type="radio" value="1" name="a_time_limit"> <?php echo(L("VALIDITY_PERIOD")); ?></label>
				</td>
				<td class="inputTip">
			...
			<tr>
				<td class="inputArea">
					<input class="i calendar" type="text" value="<?php echo date(C('APP.TIME_FORMAT'), time()); ?>" format="<?php echo(C("APP.TIME_FORMAT")); ?>" id="a_start_time" name="a_start_time" maxlength="20" size="20"> ~
					<input class="i calendar" type="text" value="<?php echo date(C('APP.TIME_FORMAT'), time()+86400*30); ?>" format="<?php echo(C("APP.TIME_FORMAT")); ?>" id="a_end_time" name="a_end_time" maxlength="20" size="20">
				</td>
				<td class="inputTip">
...
<div id="operation">
	...
	<span class="btn_b submit" action="<?php echo(Url::U("ad/add_ad_do")); ?>" to="#formAdd"><?php echo(L("SUBMIT")); ?></span>
